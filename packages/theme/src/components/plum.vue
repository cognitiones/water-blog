...
const r180 = Math.PI //圆周率π 180°
const r90 = Math.PI / 2 //圆周率π 90°
const r15 = Math.PI / 12 //圆周率π 15°
const color = '#88888825' //半透明灰色
...
<template>
    <div class="plum" :style="`mask-image: ${mask};--webkit-mask-image: ${mask};`">
